@echo off
echo [INFO] Compiling project for GUI...
...
echo [INFO] Starting Personal Finance Manager GUI...
java -cp "bin;lib/mysql-connector-j-8.3.0.jar" personalfinancemanager.app.FinanceGuiApp
